        ...
        <HoverCardTrigger className="grid w-full items-center">
          <div className="flex justify-start gap-4">
            ...
            <Checkbox
              ...
              className="mt-[2px] focus:ring-opacity-20 dark:border-border-heavy dark:bg-surface-secondary dark:text-text-primary dark:focus:ring-ring-primary dark:focus:ring-opacity-50 dark:focus:ring-offset-0"
