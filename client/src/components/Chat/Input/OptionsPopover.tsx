...
export default function OptionsPopover({
  ...
  const cardStyle =
    'shadow-xl rounded-md min-w-[75px] font-normal bg-surface-primary border-border-light border text-text-primary';
      ...
      <Content sideOffset={8} align="start" ref={popoverRef} asChild>
        <div className="z-[70] flex w-screen flex-col items-center md:w-full md:px-4">
          <div
            className={cn(
              cardStyle,
              'border-d-0 flex w-full flex-col overflow-hidden rounded-none border-s-0 border-t bg-surface-primary px-0 pb-[10px] border-border-light md:rounded-md md:border lg:w-[736px]',
            )}
          >
            <div className="flex w-full items-center bg-surface-secondary px-2 py-2">
