  ...
  return (
    <div className="max-h-[28rem] overflow-y-auto rounded-md border border-border-light">
      <table className="w-full border-separate border-spacing-0">
        <thead>
          <tr>
            <th className="sticky top-0 rounded-t border-b border-border-light bg-surface-primary px-4 py-2 text-left font-medium text-text-secondary">
              Name
            </th>
            <th className="sticky top-0 rounded-t border-b border-border-light bg-surface-primary px-4 py-2 text-left font-medium text-text-secondary">
              Date
            ...
            <th className="sticky top-0 rounded-t border-b border-border-light bg-surface-primary px-4 py-2 text-right font-medium text-text-secondary">
              <button
                className="text-text-tertiary hover:text-text-secondary radix-state-open:text-text-secondary"
                type="button"
                id="radix-:r67:"
                aria-haspopup="menu"
                aria-expanded="false"
