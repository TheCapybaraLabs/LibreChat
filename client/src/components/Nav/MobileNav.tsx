...
export default function MobileNav({
  ...
  return (
    <div className="bg-token-main-surface-primary sticky top-0 z-10 flex min-h-[40px] items-center justify-center bg-presentation pl-1 text-text-primary md:hidden">
      <button
        type="button"
