...
const SearchBar = forwardRef((props: SearchBarProps, ref: React.Ref<HTMLDivElement>) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'group relative flex h-9 cursor-pointer items-center rounded-lg border-border-medium px-3 text-text-primary transition-colors duration-200 focus-within:bg-surface-hover hover:bg-surface-hover',
        isSmallScreen === true ? 'rounded-xl' : '',
      )}
    >
