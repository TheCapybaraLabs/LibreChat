          ...
          {({ open }) => (
            <>
              <ListboxButton
                ...
                className={cn(
                  'relative flex w-full cursor-default flex-col rounded-md border border-border-light bg-surface-secondary py-2 pl-3 pr-10 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:bg-surface-secondary sm:text-sm',
                  className ?? '',
                )}
              >
                {showLabel && (
              ...
              >
                <ListboxOptions
                  className={cn(
                    'absolute z-10 mt-2 max-h-60 w-full overflow-auto rounded border border-border-medium bg-surface-dialog text-xs ring-black/10 dark:ring-white/20 md:w-[100%]',
                    optionsListClass ?? '',
                  )}
                >
                  {renderOption && (
