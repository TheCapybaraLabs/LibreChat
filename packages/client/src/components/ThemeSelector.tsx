...
const Theme = ({ theme, onChange }: { theme: string; onChange: (value: string) => void }) => {
  ...
  return (
    <button
      className="flex items-center gap-2 rounded-lg p-2 text-text-primary transition-colors hover:bg-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 dark:focus-visible:ring-0"
