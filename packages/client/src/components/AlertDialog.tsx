...
>(({ className = '', ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      'fixed inset-0 z-50 bg-surface-primary-contrast/65 transition-opacity animate-in fade-in dark:bg-black/80',
      className,
    )}
    {...props}
    ref={ref}
...
>(({ className = '', ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-md bg-surface-submit px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-surface-submit-hover focus:outline-none focus:ring-2 focus:ring-border-heavy focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:focus:ring-offset-surface-dialog',
      className,
    )}
    {...props}
  />
...
>(({ className = '', ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={cn(
      'mt-2 inline-flex h-10 items-center justify-center rounded-md border border-border-light bg-transparent px-4 py-2 text-sm font-semibold text-text-primary transition-colors hover:bg-surface-hover focus:outline-none focus:ring-2 focus:ring-border-heavy focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:focus:ring-offset-surface-dialog sm:mt-0',
      className,
    )}
    {...props}
  />
