      ...
      <div className="relative rounded-lg transition-all duration-500 ease-in-out">
        <div className="relative">
          ...
          <div className="absolute left-3 top-1/2 z-50 -translate-y-1/2">
            <Search
              className={cn(
                ...
                isSearching && hasValue ? 'text-blue-400' : 'text-text-tertiary',
              )}
            />
          </div>
          ...
          <input
            ...
            className={`peer relative z-20 w-full rounded-lg bg-surface-secondary py-2 pl-10 outline-none backdrop-blur-sm transition-all duration-500 ease-in-out placeholder:text-text-tertiary focus:ring-ring`}
          />
