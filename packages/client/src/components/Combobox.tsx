      ...
      >
        <SelectTrigger
          ...
          className={cn(
            ...
            isCollapsed
              ...
              : '',
            'bg-surface-secondary text-text-primary hover:bg-surface-hover focus-visible:ring-2 focus-visible:ring-ring-primary',
          )}
        >
        ...
        <RadixSelect.Portal>
          <RadixSelect.Content
            ...
            position="popper"
            className={cn(
              'bg-popover text-popover-foreground relative z-40 max-h-[52vh] min-w-[8rem] overflow-hidden rounded-md border border-border-light shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
          ...
          >
            <RadixSelect.Viewport className="mb-5 h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)]">
              <div className="group sticky left-0 top-0 z-10 flex h-12 items-center gap-2 bg-surface-dialog px-3 py-2 text-text-primary duration-300">
                <SearchIcon className="h-4 w-4 text-text-tertiary transition-colors duration-300 group-focus-within:text-text-secondary group-hover:text-text-secondary" />
                <Combobox
                  autoSelect
                ...
                <ComboboxCancel
                  hideWhenEmpty={true}
                  className="relative flex h-5 w-5 items-center justify-end text-text-tertiary transition-colors duration-300 group-focus-within:text-text-secondary group-hover:text-text-secondary"
                />
              </div>
                  ...
                  <RadixSelect.Item key={value} value={`${value ?? ''}`} asChild>
                    <ComboboxItem
                      className={cn(
                        ...
                        'rounded-lg text-text-primary hover:bg-surface-hover',
                      )}
                      /** Hacky fix for radix-ui Android issue: https://github.com/radix-ui/primitives/issues/1658  */
                      onTouchEnd={() => {
                        setValue(`${value ?? ''}`);
                    ...
                    >
                      ...
                      <RadixSelect.ItemText>
                        <div className="flex items-center justify-center gap-3 text-text-primary [&_svg]:h-4 [&_svg]:w-4 [&_svg]:shrink-0 [&_svg]:text-foreground">
